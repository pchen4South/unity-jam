...
Shader "RealToon/Version 5/Tessellation/Fade Transparency" {
    Properties {
        ...
        [MaterialToggle] _OutlineWidthAffectedByViewDistance ("Outline Width Affected By View Distance", Float ) = 1
    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                o.pos = UnityObjectToClipPos( float4(v.vertex.xyz + v.normal*((clamp(lerp( _VertexColorRedAffectOutlineWitdh_var, (_VertexColorRedAffectOutlineWitdh_var*node_1229), _OutlineWidthAffectedByViewDistance ),0.0,2000.0)*0.01)*_OutlineWidthControl_var.r*lerp(1.0,node_9863,_NoisyOutlineIntensity)),1) );
